...
struct Scene{
    ...
    void render() {
        ...
        {
            Light & light = scene_lights[i];
            std::string lightName = "lightSources[" + std::to_string(i) + "]";
            std::string shadowMapName = "shadowMap[" + std::to_string(i) + "]";
            shaderProgramPtr->set ((lightName + ".position"), light.m_position);
            shaderProgramPtr->set ((lightName + ".color"), light.m_color);
            shaderProgramPtr->set ((lightName + ".intensity"), light.m_intensity);
